	...
	<body>
		<table border=0 cellspacing='1' bgcolor='black' cellpadding='5'>
			...
			<tr bgcolor='white' height='30' style='font-size:12pt;'>
				...
				<td> 车行道宽12.00m 人行道宽5m </td>
			</tr>
			<tr align='center' bgcolor='white' height='30'>
				<td class='gradientGray'>开工日期</td>
				<td align='left'>2016-02-23</td>
			</tr>
			<tr align='center' bgcolor='white' height='30'>
				<td class='gradientGray'>完工日期</td>
				<td align='left'>2017-03-30</td>
			</tr>
			<tr align='center' bgcolor='white' height='30'>
				<td class='gradientGray'>施工许可证号</td>
				<td align='left'>321111201709010201</td>
			</tr>
			<tr align='center' bgcolor='white' height='30'>
				<td class='gradientGray'>规划许可证号</td>
				<td align='left'>321111201500124</td>
			</tr>
			<tr align='center' bgcolor='white' height='30'>
				<td class='gradientGray'>施工图设计文件<br><span style='letter-spacing:2.9px;'>审查合格书号</span></td>
				<td align='left'>镇RZ-2015-S36</td>
			</tr>
			<tr align='center' bgcolor='white' height='30'>
				<td class='gradientGray'>勘察单位</td>
				<td align='left'>镇江八一四勘察测绘有限公司</td>
			</tr>
			<tr align='center' bgcolor='white' height='30'>
				<td class='gradientGray'>资质等级</td>
				<td align='left'>工程勘察专业类乙级</td>
			</tr>
			<tr align='center' bgcolor='white' height='30'>
				<td class='gradientGray'>设计单位</td>
				<td align='left'>镇江市规划设计研究院</td>
			</tr>
			<tr align='center' bgcolor='white' height='30'>
				<td class='gradientGray'>资质等级</td>
				<td align='left'>市政行业甲级</td>
			</tr>
			<tr align='center' bgcolor='white' height='30'>
				<td class='gradientGray'>施工单位</td>
				<td align='left'>江苏山水环境建设集团股份有限公司</td>
			</tr>
			<tr align='center' bgcolor='white' height='30'>
				<td class='gradientGray'>资质等级</td>
				<td align='left'>市政公用工程总承包壹级</td>
			</tr>
			<tr align='center' bgcolor='white' height='30'>
				<td class='gradientGray'>监理单位</td>
				<td align='left'>镇江建科工程管理有限公司</td>
			</tr>
			<tr align='center' bgcolor='white' height='30'>
				<td class='gradientGray'>资质等级</td>
				<td align='left'>市政工程甲级</td>
			</tr>
			<tr align='center' bgcolor='white' height='30'>
				<td class='gradientGray'>工程质量监督机构</td>
				<td align='left'>镇江市建设工程监督站</td>
			</tr>
			<tr align='center' bgcolor='white' height='30'>
				<td class='gradientGray'>监督注册号</td>
				<td align='left'>3211000201500010013</td>
			</tr>
			<tr bgcolor='white' height='30'>
			...
			<tr bgcolor='white' height='30' style='font-size:12pt;'>
				...
				<td>3211111509220201-JX-003</td>
			</tr>
			<tr bgcolor='white' height='30' style='font-size:12pt;'>
				<td align='center'>
					<div style='width:100'>备案日期</div>
				</td>
				<td align='left'>2017-09-10</td>
			</tr>
			<tr align='center' bgcolor='white' height='30'>
